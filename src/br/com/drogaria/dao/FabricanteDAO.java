...
public class FabricanteDAO {
	...
	public Fabricante buscarPorCodigo(Fabricante f) throws SQLException {
		...
		ResultSet resultado = comando.executeQuery(); // Variável que guarda o
	...
	public static void main(String[] args) {
		/*
		 * Fabricante f1 = new Fabricante(); f1.setDescricao("DESCRIÇÂO 1");
		 * Fabricante f2 = new Fabricante(); f2.setDescricao("DESCRIÇÂO 2");
		 * 
		 * FabricanteDAO fdao = new FabricanteDAO();
		 * 
		 * try { fdao.salvar(f1); fdao.salvar(f2); System.out.println(
		 * "Os fabricantes fomram salvos com sucesso!"); } catch (SQLException
		 * e) { System.out.println(
		 * "Ocorreu um erro ao tentar salvar um fabricante!");
		 * e.printStackTrace(); }
		 */
		 ...
		 * "Ocorreu um erro ao tentar remover um dos fabricantes!");
		 * e.printStackTrace(); }
		 */

		/*
		 * Fabricante f1 = new Fabricante(); f1.setCodigo(3L); f1.setDescricao(
		 * "Descricao 3");
		 * 
		 * FabricanteDAO fdao = new FabricanteDAO();
		 * 
		 ...
		 * "Ocorreu um erro ao tentar editar o fabricante!");
		 * e.printStackTrace(); }
		 */
